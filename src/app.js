...
function renderIngredientsBoard(){
  document.getElementById("items").style.visibility=state.Patty?"visible":"hidden";
  document.getElementById("items").style.visibility=state.Cheese?"visible":"hidden";
  document.getElementById("items").style.visibility=state.Tomatoes?"visible":"hidden";
  document.getElementById("items").style.visibility=state.Onions?"visible":"hidden";
  document.getElementById("items").style.visibility=state.Lettuce?"visible":"hidden";
}
//Judgement 1
